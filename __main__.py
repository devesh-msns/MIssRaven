...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am a LIT AF  group management bot.
You can find the list of available commands with /help.
Special thanks to @TheDemon_himself for helping in developing me.
"""
...
TECHNO_IMG = "https://telegra.ph/file/bd087695dc1ad1fd0a649.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url=f"tg://user?id{OWNER_ID}")],
                                                                                   [InlineKeyboardButton(text="ADD this lit af in ur grp",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/devesh-msns/MIssRaven.git")
                                                                                 ]]))
