...
def new_member(bot: Bot, update: Update, job_queue: JobQueue):
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == 1432685006:
                update.effective_message.reply_text("MY GOD ! My owner , legendary and git af pero Demon just arrived!! All hail my owner!")
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text("Whoa! A Powerful pero guy just joined!")
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text("Hey! A support user joined! wew")
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("Bam ! i am here to save the day")
